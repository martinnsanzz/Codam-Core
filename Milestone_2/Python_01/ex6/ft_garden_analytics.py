...
class Plant:
    ...
    @classmethod
    def anonymous(cls, name: str, height: float,
                  plant_age: int, growth_rate: float) -> 'Plant':
        return cls(name, height, plant_age, growth_rate)
...
if __name__ == "__main__":
    ...
    unknown: Plant = Plant.anonymous("Unknown plant", 0.0, 0, 0.0)

    unknown.show()
    flower.check_days(30)
    flower.check_days(365)